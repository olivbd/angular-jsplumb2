module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		srcdir: "src",
		builddir: ".work/.tmp",
		name: grunt.file.readJSON("package.json").name || "angular-jsplumb2", // module name
		...
		ngdocs: {
			options: {
				...
				startPage: "/api/angular-jsplumb2.directive:jsplumbInstance",
				sourceLink: "https://github.com/olivbd/<%= name %>/blob/master/{{file}}#L{{codeline}}"
			},
			api: {
				src: ["src/**/*.js"],
				title: "api"
